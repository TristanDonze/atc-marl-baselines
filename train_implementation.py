...
def train_stage(stage, seed, artifact_root, num_envs, warm_start_model, warm_start_normalizer, previous_stage, run_aim):
    ...
    rollout_steps = 1024
    num_updates = stage.total_timesteps // (num_envs * rollout_steps)
